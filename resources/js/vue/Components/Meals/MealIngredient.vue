<template>
    <div class="font-bold flex items-center p-2 border mb-3">
        <svg
        ...
        <input type="text" v-model="quantity" class="form-input w-24 mr-4" />
        <p class="flex-1">{{ ingredient.description }}</p>
