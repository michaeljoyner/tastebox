...
import { showSuccess, showError, showWarning } from "../../libs/notifications";
...
export default {
    ...
    methods: {
        fetchMeal() {
            return this.$store.dispatch("meals/findById", this.mealId);
        },

        setForm(meal_data) {
            this.formData = meal_data;
        },
        ...
        save() {
            ...
            this.$store
                .dispatch("meals/saveMeal", { id: this.mealId, mealData })
