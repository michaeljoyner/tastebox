...
class NotifyAdminOnOrderPaidTest extends TestCase
{
    use RefreshDatabase;
     ...
     *@test
     */
    public function admin_gets_notified_when_payment_received()
    {
        Mail::fake();
        ...
        Mail::assertQueued(AdminOrderConfirmed::class, fn ($mail) => $mail->customer_name === 'Smarty Pants');
    }
